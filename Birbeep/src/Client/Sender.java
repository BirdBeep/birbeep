				...
				try {
					...
					try {		
						...
						case 5:
							...
							break;
						case 6:
							Certificate cert= new JSONDeserializer<Certificate>().deserialize(ois.readObject().toString(),Certificate.class);
							System.out.println(cert.getPublicKey().getEncoded().toString());
							break;
						case 7:
							do {
								Usuarios usuario1= new JSONDeserializer<Usuarios>().deserialize(ois.readObject().toString(),Usuarios.class);
